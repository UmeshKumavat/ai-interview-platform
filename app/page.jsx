...
import { Bot, Wallet, Video, MessageSquare, ShieldCheck, BarChart3, CalendarRange } from "lucide-react";
        ...
        <div className="flex flex-wrap items-center justify-center gap-24 px-6">
          {LOGOS.map((l) => (
            <Image
              ...
              width={50}
              height={50}
              className="h-6 w-auto opacity-60 grayscale hover:grayscale-0 cursor-pointer"
            />
          ))}
        </div>
      </section>
      ...
      <section className="relative z-10 py-28 max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-4">
            <BentoCard
              icon={<Video size={18} className="text-amber-400" />}
          ...
          <div className="col-span-12 md:col-span-6">
            <BentoCard
              icon={<CalendarRange size={18} className="text-amber-400" />}
